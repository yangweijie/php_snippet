...
class Index extends BaseController
{
    public function index()
    {
    	$ding = new \bingher\ding\DingBot([
    		'webhook'=>'https://oapi.dingtalk.com/robot/send?access_token=0a5ac696c7b3b3a202c13d6ba2721792be6b2ab4d1235240891d970d57248ca9'
    	]);

		//发送文本消息
		$res = $ding->text('http hello hello');
		return json($res);
		return '1213';
